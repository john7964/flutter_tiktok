...
typedef OnVideoSizeChanged = void Function(int width, int height, int? rotation, String playerId);
typedef OnSnapShot = void Function(String path, String playerId);
typedef OnSeekComplete = void Function(String playerId);
typedef OnSeiData = void Function(int type, Uint8List uuid, Uint8List data, String playerId);
...
typedef OnSubtitleShow =
    void Function(int trackIndex, int subtitleID, String subtitle, String playerId);
...
typedef OnError =
    void Function(int errorCode, String? errorExtra, String? errorMsg, String playerId);
...
typedef OnThumbnailGetSuccess = void Function(Uint8List bitmap, Int64List range, String playerId);
...
typedef OnTimeShiftUpdater =
    void Function(int currentTime, int shiftStartTime, int shiftEndTime, String playerId);
typedef OnStreamSwitchedSuccess = void Function(String url);
typedef OnStreamSwitchedFail = void Function(String url, int errorCode, String errorMsg);
...
class FlutterAliplayer {
  ...
  void setOnStateChanged(OnStateChanged? stateChanged) {
    ...
    FlutterAliPlayerFactory.methodChannel.invokeMethod(
      'setOnStateChanged',
      wrapWithPlayerId(arg: (null != stateChanged)),
    );
    if (null != stateChanged) {
      BasicMessageChannel<String> _basicMessageChannel = BasicMessageChannel<String>(
  ...
  /// 设置切换清晰度监听（直播流）
  Future<void> setOnStreamSwitchedListener(
    OnStreamSwitchedSuccess? onSuccess,
    OnStreamSwitchedFail? onFail,
  ) async {
    ...
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("setOnStreamSwitchedListener", {
  ...
  Future<void> create() async {
    var invokeMethod = FlutterAliPlayerFactory.methodChannel.invokeMethod(
      'createAliPlayer',
      wrapWithPlayerId(arg: PlayerType.PlayerType_Single),
    );
  ...
  Future<void> clearScreen() async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod('clearScreen', wrapWithPlayerId());
  }
  ...
  Future<void> releaseAsync() async {
    FlutterAliPlayerFactory.instanceMap.remove(playerId);
    return FlutterAliPlayerFactory.methodChannel.invokeMethod('releaseAsync', wrapWithPlayerId());
  }
  ...
  Future<void> setAutoPlay(bool isAutoPlay) async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      'setAutoPlay',
      wrapWithPlayerId(arg: isAutoPlay),
    );
  }
  ...
  Future<void> setFastStart(bool fastStart) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "setFastStart",
      wrapWithPlayerId(arg: fastStart),
    );
  }
  ...
  Future<void> setEnableHardwareDecoder(bool isHardWare) async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      ...
      wrapWithPlayerId(arg: isHardWare),
    );
  }

  /// 软解码时生效，是否只返回底层音频数据地址，mAudioDataAddr默认为false,
  /// 是否只返回底层视频数据地址，默认为true
  Future<void> setRenderFrameCallbackConfig(bool mAudioData, bool mVideoData) async {
    var map = {"mAudioData": mAudioData, "mVideoData": mVideoData};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      'setRenderFrameCallbackConfig',
      wrapWithPlayerId(arg: map),
    );
  }
  ...
  Future<void> setLiveSts({
    ...
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "setLiveSts",
      wrapWithPlayerId(arg: liveStsInfo),
    );
  }
  ...
  Future<void> setVideoBackgroundColor(var color) async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      ...
      wrapWithPlayerId(arg: color),
    );
  }

  /// 获取视频的宽度
  Future<dynamic> getVideoWidth() async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod('getVideoWidth', wrapWithPlayerId());
  }

  /// 获取视频的高度
  Future<dynamic> getVideoHeight() async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod('getVideoHeight', wrapWithPlayerId());
  }
  ...
  Future<int> getDuration() async {
    int value = await FlutterAliPlayerFactory.methodChannel.invokeMethod(
      'getDuration',
      wrapWithPlayerId(),
    );
    return value;
  ...
  Future<AVPConfig> getPlayConfig() async {
    Map map = await FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "getPlayConfig",
      wrapWithPlayerId(),
    );
  ...
  Future<void> enableDowngrade(String source, AVPConfig config) async {
    Map map = {"source": source, "config": config.convertToMap()};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "enableDowngrade",
      wrapWithPlayerId(arg: map),
    );
  ...
  Future<void> setFilterConfig(String configJson) async {
    ...
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "setFilterConfig",
      wrapWithPlayerId(arg: configJson),
    );
  }
  ...
  /// 根据vid获取缓存的文件名
  Future<dynamic> getCacheFilePathWithVid(String vid, String format, String definition) async {
    var map = {'vid': vid, 'format': format, 'definition': definition};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "getCacheFilePathWithVid",
      wrapWithPlayerId(arg: map),
    );
  }
  ...
  Future<dynamic> getCacheFilePathWithVidAtPreviewTime(
    ...
    var map = {'vid': vid, 'format': format, 'definition': definition, 'previewTime': previewTime};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
  ...
  Future<dynamic> createThumbnailHelper(String thumbnail) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      ...
      wrapWithPlayerId(arg: thumbnail),
    );
  }
  ...
  Future<void> selectTrack(int trackIdx, {int accurate = -1}) {
    var map = {'trackIdx': trackIdx, 'accurate': accurate};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "selectTrack",
      wrapWithPlayerId(arg: map),
    );
  ...
  Future<void> setPreferPlayerName(String playerName) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "setPreferPlayerName",
      wrapWithPlayerId(arg: playerName),
    );
  }
  ...
  Future<void> setUserData(String userData) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "setUserData",
      wrapWithPlayerId(arg: userData),
    );
  }

  /// 设置UserData，用于一些全局API的透传，以区分player实例。
  Future<dynamic> getUserData() async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("getUserData", wrapWithPlayerId());
  }
  ...
  Future<void> reload() async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod('reload', wrapWithPlayerId());
  }
  ...
  Future<dynamic> getOption(AVPOption key) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "getOption",
      wrapWithPlayerId(arg: key.index.toString()),
    );
  }
  ...
  Future<dynamic> setEventReportParamsDelegate(int argt) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      ...
      wrapWithPlayerId(arg: argt.toString()),
    );
  }
  ...
  static Future<bool> isFeatureSupport(SupportFeatureType type) async {
    bool boolV = await FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "isFeatureSupport",
      type.index,
    );
    return boolV;
  ...
  /// 替代旧版本的[enableMix]
  static Future<void> setAudioSessionTypeForIOS(AliPlayerAudioSesstionType type) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "setAudioSessionTypeForIOS",
      type.index,
    );
  }
  ...
  static Future<void> setLogOption(int value) async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("setLogOption", value);
  }
  ...
  static Future<void> setUseHttp2(bool use) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("setUseHttp2", use);
  }

  /// 是否开启httpDNS
  /// 默认不开启
  static Future<void> enableHttpDns(bool enable) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("enableHttpDns", enable);
  }
  ...
  static Future<void> setDNSResolve(String host, String ip) {
    Map map = {"host": host, "ip": ip};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("setDNSResolve", map);
  }
  ...
  static Future<void> setFairPlayCertIDForIOS(String certID) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("setFairPlayCertIDForIOS", certID);
  }

  /// 设置是否使能硬件提供的音频变速播放能力
  /// 关闭后则使用软件实现音频的倍速播放，pcm回调数据的格式和此设置关联；默认打开
  static Future<void> enableHWAduioTempo(bool enable) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("enableHWAduioTempo", enable);
  }
  ...
  static Future<void> forceAudioRendingFormat(
    ...
    var map = {'force': force, 'fmt': fmt, 'channels': channels, 'sample_rate': sample_rate};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("forceAudioRendingFormat", map);
  }

  /// 重连所有网络连接
  /// 网络路由发生变化后，调用此接口，可以让播放器所有的连接切换到新的路由上去。
  static Future<void> netWorkReConnect() {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("netWorkReConnect");
  }
  ...
  static Future<void> enableLocalCache(
    bool enable,
    String maxBufferMemoryKB,
    String localCacheDir,
    DocTypeForIOS docTypeForIOS,
  ) {
    var map = {
      'enable': enable,
    ...
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("enableLocalCache", map);
  }

  /// 本地缓存文件自动清理相关的设置
  static Future<void> setCacheFileClearConfig(
    String expireMin,
    String maxCapacityMB,
    String freeStorageMB,
  ) {
    var map = {
      'expireMin': expireMin,
    ...
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("setCacheFileClearConfig", map);
  }

  /// 是否开启内建预加载网络平衡策略，播放过程中，自动控制预加载的运行时机。默认开启。
  /// enable 是否开启
  static Future<void> enableNetworkBalance(bool enable) {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("enableNetworkBalance", enable);
  }
  ...
  static Future<void> addBlackDevice(String type, String model) async {
    var map = {'black_type': type, 'black_device': model};
  ...
  static Future<void> createVidPlayerConfigGenerator() async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("createVidPlayerConfigGenerator");
  }
  ...
  static Future<void> setHlsUriToken(String mtsHlsUriToken) async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("setHlsUriToken", mtsHlsUriToken);
  }
  ...
  static Future<void> addVidPlayerConfigByStringValue(String key, String value) async {
    Map param = {key: value};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "addVidPlayerConfigByStringValue",
      param,
    );
  }
  ...
  /// value: 对应key参数的整形值
  /// 调用之前必须先执行[createVidPlayerConfigGenerator]
  static Future<void> addVidPlayerConfigByIntValue(String key, int value) async {
    Map param = {key: value.toString()};
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      "addVidPlayerConfigByIntValue",
      param,
    );
  }
  ...
  static Future<void> setEncryptType(EncryptType type) async {
    ...
    return FlutterAliPlayerFactory.methodChannel.invokeMethod("setEncryptType", encryptType);
  }

  /// 生成playerConfig
  /// 调用之前必须先执行[createVidPlayerConfigGenerator]
  static Future<String> generatePlayerConfig() async {
    return await FlutterAliPlayerFactory.methodChannel.invokeMethod("generatePlayerConfig");
  }

  /// 设置加载url的hash值回调。如果不设置，SDK使用md5算法。
  Future<void> setDrmCallback(
    Function(Object, Object) requestProvision,
    Function(Object, Object) requestKey,
  ) async {
    BasicMessageChannel<String> _basicMessageChannel = BasicMessageChannel<String>(
      "requestProvision",
      StringCodec(),
    );
    BasicMessageChannel<String> _basicMessageChannel2 = BasicMessageChannel<String>(
      "requestKey",
      StringCodec(),
    );
    // 注册调用 Flutter 端的 callback, 并发送至 Native 端
    ...
    try {
      await FlutterAliPlayerFactory.methodChannel.invokeMethod('setDrmCallback');
  ...
  /// 设置预渲染帧回调。
  Future<void> setOnPreRenderFrameCallback(Function(Object) onPreRenderFrame) async {
    BasicMessageChannel<String> _basicMessageChannel = BasicMessageChannel<String>(
      "onPreRenderFrame",
      StringCodec(),
    );
    ...
    try {
      await FlutterAliPlayerFactory.methodChannel.invokeMethod(
        'setOnPreRenderFrameCallback',
        wrapWithPlayerId(),
      );
    } on PlatformException catch (e) {
      print("Failed to register callback: '${e.message}'.");
    ...
    switch (method) {
      ...
      case "onUpdater":
        if (player._onTimeShiftUpdater != null) {
          ...
          player._onTimeShiftUpdater!(currentTime, shiftStartTime, shiftEndTime, playerId);
        }
        break;
