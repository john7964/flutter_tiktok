...
class FlutterAliLiveShiftPlayer extends FlutterAliplayer {
  ...
  Future<dynamic> getCurrentTime() async {
    return FlutterAliPlayerFactory.methodChannel.invokeMethod('getCurrentTime', wrapWithPlayerId());
  }
  ...
  Future<void> setDataSource(
    ...
    return FlutterAliPlayerFactory.methodChannel.invokeMethod(
      'setDataSource',
      wrapWithPlayerId(arg: dataSourceMap),
    );
  }
}
