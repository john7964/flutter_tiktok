...
import 'flutter_alilistplayer.dart';
import 'flutter_aliliveshiftplayer.dart';
import 'flutter_aliplayer.dart';

class FlutterAliPlayerFactory {
  static const MethodChannel methodChannel = MethodChannel("plugins.flutter_aliplayer_factory");
